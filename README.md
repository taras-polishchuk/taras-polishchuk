...
- [`job-tracker`](https://github.com/taras-polishchuk/job-tracker) — Kanban board for tracking job applications (Svelte 5 + Vite → [live](https://taras-polishchuk.github.io/job-tracker/))
...
![Liquid](https://img.shields.io/badge/Liquid-7ab55c?style=flat-square&logoColor=white)
